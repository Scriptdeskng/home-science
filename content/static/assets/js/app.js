...
(function (window, document, $, undefined) {
  ...
  window.Init = {
    ...
    VideoPlayer: function (videoFiles = [], posterImage = "") {
      if ($("#video").length) {
        $("#video").html(""); // Clear any previous video instance
        
        $("#video").aksVideoPlayer({
          file: videoFiles, // This should be an array of objects with { file, label }
          poster: posterImage || "assets/media/anime/default.jpg", // Fallback poster
          forward: true,
          rewind: true,
          seek: true,
          volume: true,
